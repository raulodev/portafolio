...
export const NavDesktop = ({
  ...
  return (
    <div className="hidden lg:flex fixed top-0 bottom-0 right-7 justify-center items-center w-[7%]">
      <div className="flex flex-col items-center justify-center gap-6 px-2 py-6 rounded-full bg-amber-400">
        <Link href="/">
          <motion.svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className={home ? "w-6 h-6 text-white" : "w-6 h-6 text-zinc-800"}
          >
