      ...
      <main className="min-h-screen selection:bg-green-500 selection:text-white">
        <div className="grid grid-cols-1 xl:grid-cols-2">
          <div className="flex items-center justify-center min-h-screen bg-zinc-800">
            <div className="w-3/4 space-y-5 text-center xl:text-left sm:w-2/3 xl:3/4 ">
              ...
              <div className="flex justify-center mt-5">
                <Link href="/about">
                  <div className="px-5 py-3 text-xl font-bold text-white uppercase transition-all ease-in-out bg-green-600 rounded-full shadow-lg hover:bg-green-500 hover:shadow w-max">
                    Sobre mi
                  </div>
                </Link>
              </div>
