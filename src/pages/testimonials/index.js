...
function Home() {
  return (
    <>
      ...
      <main className="flex min-h-screen select-none bg-gradient-to-r from-gray-100 to-gray-300">
          ...
          <div className="w-full p-10 space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: false }}
                className="max-w-md px-8 py-4 my-10 bg-black rounded shadow-lg"
              >
                ...
                <div>
                  <h2 className="text-xl font-semibold text-yellow-500">Design Tools</h2>
                  <p className="mt-2 text-white">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores deserunt
                    ea doloremque natus error, rerum quas odio quaerat nam ex commodi hic, suscipit
                    in a veritatis pariatur minus consequuntur!
                  </p>
                </div>
